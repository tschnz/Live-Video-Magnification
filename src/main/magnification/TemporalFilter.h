...
/*!
 * \brief iirWaveletFilter (Wavelet Magnification) Applies an iirFilter (in
 * space domain) on 1 level of a DWT. \param src \param dst \param lowpassHi
 * \param lowpassLo
 * \param cutoffLo
 * \param cutoffHi
 */
...
public:
  RieszTemporalFilter()
      : itsFrequency(0.0), itsFramerate(0.0), itsA(), itsB() {}
